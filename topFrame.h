...
class DlgAudio : public wxDialog
{
    ...
    public:
        ...
        DlgAudio( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Audio Options"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 436,377 ), long style = wxDEFAULT_DIALOG_STYLE );
        ~DlgAudio();
